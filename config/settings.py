...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'accounts' / 'templates', BASE_DIR / 'reservation' / 'templates', ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTH_USER_MODEL = 'accounts.Receptionist'
...
###both state to login with username and mail
AUTHENTICATION_BACKENDS = (
    'accounts.backends.UsernameOrEmailModelBackend',
