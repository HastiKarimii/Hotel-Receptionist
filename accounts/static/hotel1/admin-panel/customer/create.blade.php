            ...
            <div id="kt_header" class="header">
                ...
                <div class="container-fluid d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
                    ...
                    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 pb-5 pb-lg-0 pt-7 pt-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                        <!--begin::Heading-->
                        <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">افزودن رزرو جدید</h1>
                        <!--end::Heading-->
                    </div>
                    <!--end::Page title=-->
                    <!--begin::Wrapper-->
                    ...
                    <form action="#" method="post" class="mx-auto" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col form-box">
                                <div class="d-flex">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" class="form-control" id="fname" placeholder="نام" name="fname">
                                    </div>
                                    <div class="form-group col mx-8">
                                        <label for="lname">نام خانوادگی</label>
                                        <input type="text" class="form-control" id="lname" placeholder="نام خانوادگی" name="lname">
                                    </div>
                                    <div class="form-group col">
                                ...
                                <div class="d-flex">
                                    <div class="form-group col">
                                        <label for="start_date">تاریخ ورود</label>
                                        <input type="text" class="form-control input-date" id="start_date" placeholder="تاریخ ورود" name="start_date">
                                    </div>
                                    <div class="form-group col mx-8">
                                        <label for="end_date">تاریخ خروج</label>
                                        <input type="text" class="form-control input-date" id="end_date" placeholder="تاریخ خروج" name="end_date">
                                    </div>
                                    <div class="form-group col">
                                        <label for="type_room">نوع اتاق</label>
                                        <select name="type_room" id="type_room" class="form-control form-select" aria-label="Default select example">
                                            <option selected>انتخاب کنید</option>
                                            <option value="0">تک نفره</option>
                                            <option value="1">دو نفره</option>
                                            <option value="2">سه نفره</option>
                                            <option value="2">چهار نفره</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="d-flex">
                            ...
                            <div class="d-flex justify-content-end mt-12">
                                <a href="#" class="btn btn-secondary form-btn me-3">بازگشت</a>
                                <button type="submit" class="btn form-btn">ذخیره تغییرات</button>
                            </div>
                        </div>
                    </form>
                </div>
